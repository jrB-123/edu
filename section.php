...
<html>
<?php 
require_once('./php/addCardSection.php');
...
<body>
    <ul class="nav flex-column shadow d-flex sidebar mobile-hid" style="background: #111111;">
        ...
        <li class="nav-item dropdown show"><a class="dropdown-toggle nav-link text-left text-white py-1 px-0 position-relative" aria-expanded="true" data-toggle="dropdown" href="#"><i class="fas fa-folder-open mx-3"></i><span class="text-nowrap mx-2">Sections</span><i class="fas fa-caret-down float-none float-lg-right fa-sm"></i></a>
            <div class="dropdown-menu show border-0 animated fadeIn"><a class="dropdown-item text-white" href="#"><span>AM 1</span></a><a class="dropdown-item text-white" href="#"><span>AM 2</span></a><a class="dropdown-item text-white" href="#"><span>AM 3</span></a><a class="dropdown-item text-white" href="#"><span>AM 4</span></a></div>
        </li>
    ...
    <div class="card"></div>
                ...
                addCardSection($row['section_id'], $row['section_name'], $row['section_enrollees'], $row['course_code'], $row['course_desc']);
				}
				?>						
